...
export default function ObjectPage() {
  ...
  return(
    ...
    <div className="ObjectPage">
      <div>
        <div className="СhapterDiv">
          <span className="SpanСhapter">Раздел:</span><input className="InputСhapter" value={object.chapter} disabled={!editState} onChange={(e)=>setObject({...object, chapter: e.target.value})} autoComplete="off"/>
        </div>
